...
export async function updateSession(request: NextRequest) {
  ...
  const protectedPaths = ['/dashboard', '/inbox', '/agents', '/settings', '/call-logs', '/contacts', '/data', '/documents', '/voice-agents', '/workflows', '/voice-settings', '/phone-numbers', '/templates', '/upload', '/processing', '/processing-queue', '/extracted-data', '/profile']
