  ...
  return (
    <>
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
        {/* Greeting Settings */}
        <Card variant="default" className="sm:rounded-2xl sm:p-6 lg:p-8 mb-4 sm:mb-6 border-2 border-transparent hover:border-service-voice-200/50 transition-all duration-300">
