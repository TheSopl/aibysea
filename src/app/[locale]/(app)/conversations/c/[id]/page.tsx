...
import { MessageCompose } from '@/features/inbox/components/MessageCompose'
import { TakeoverButton } from '@/features/inbox/components/TakeoverButton'
    ...
    <div className="h-full flex flex-col">
      ...
      <div className={`px-4 py-2 text-sm font-medium ${
        conversation.handler_type === 'ai'
          ...
          : 'bg-service-documents-50 text-service-documents-700'
      }`}>
        {conversation.handler_type === 'ai'
