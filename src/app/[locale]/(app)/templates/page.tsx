    ...
    <>
      ...
      <div className="p-4 sm:p-6 lg:p-8 bg-light-bg dark:bg-slate-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {templates.map(template => (
                <div
                  key={template.id}
                  className="bg-white dark:bg-gray-800 rounded-design-lg p-card shadow-card border-2 border-transparent hover:border-service-documents-200/50 transition-all duration-300 cursor-pointer"
          ...
          {showCreateForm && (
            <Card variant="default" className="rounded-2xl shadow-2xl border-2 border-service-documents-200 max-h-[calc(100vh-160px)] sm:max-h-[calc(100vh-200px)] overflow-y-auto">
