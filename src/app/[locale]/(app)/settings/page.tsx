...
const channelBrandConfig: Record<string, { Icon: React.ComponentType<{ size?: number; className?: string }>; color: string; bgColor: string }> = {
  WhatsApp: { Icon: FaWhatsapp, color: '#25D366', bgColor: '#25D366' },
  Telegram: { Icon: FaTelegramPlane, color: '#0088CC', bgColor: '#0088CC' },
  Facebook: { Icon: FaFacebook, color: '#1877F2', bgColor: '#1877F2' },
  Instagram: { Icon: FaInstagram, color: '#E4405F', bgColor: '#E4405F' },
};
              ...
              <div className="space-y-6">
                <Card variant="default" className="sm:rounded-2xl">
                  ...
                  <button
                    ...
                    className="mt-4 w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 text-white rounded-lg sm:rounded-xl font-bold text-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center gap-2"
            ...
            {activeTab === 'team' && (
              <div className="space-y-4 sm:space-y-6">
                <Card variant="default" className="sm:rounded-2xl">
                  ...
                  <button
                    className="mt-4 sm:mt-6 w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 text-white rounded-lg sm:rounded-xl font-bold text-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center gap-2"
                    style={{ background: 'linear-gradient(to right, #003EF3, #4EB6C9)' }}
                  >
                ...
                <Card variant="default" className="sm:rounded-2xl border-2 border-red/20">
              ...
              <div className="space-y-4 sm:space-y-6">
                <Card variant="default" className="sm:rounded-2xl">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 sm:mb-6">
                    ...
                    <button
                      className="w-full sm:w-auto px-3 sm:px-4 py-2 text-white rounded-lg sm:rounded-xl font-bold text-sm hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2"
                      style={{ background: 'linear-gradient(to right, #003EF3, #4EB6C9)' }}
                    >
                      ...
                      >
                        <div className="flex items-start justify-between gap-3 mb-3 sm:mb-4">
                          <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                            {(() => {
                              const brand = channelBrandConfig[channel.type];
                              const BrandIcon = brand?.Icon || Radio;
                              return (
                                <div
                                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg flex-shrink-0"
                                  style={{ background: channel.status === 'connected' ? (brand?.bgColor || '#003EF3') : '#9CA3AF' }}
                                >
                                  <BrandIcon className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                                </div>
                              );
                            })()}
                        ...
                        <div className="flex gap-2">
                          {channel.status === 'connected' ? (
                            ...
                            <button
                              className="w-full px-3 py-2 text-white rounded-lg font-bold text-xs sm:text-sm hover:shadow-lg transition-all"
                              style={{ background: 'linear-gradient(to right, #003EF3, #4EB6C9)' }}
                            >
                              Connect
                            </button>
