            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-text-secondary mt-1">Manage and monitor your AI workforce</p>
                </div>
                ...
                {agents.map((agent, index) => (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div>
                        <p className="text-xs text-text-secondary font-bold uppercase tracking-wider mb-1">Conversations</p>
                        <p className="text-lg font-extrabold text-dark">{agent.totalConversations.toLocaleString()}</p>
                      </div>
                      <div>
                        <p className="text-xs text-text-secondary font-bold uppercase tracking-wider mb-1">Response</p>
                        <p className="text-lg font-extrabold text-dark">{agent.avgResponseTime}s</p>
                      </div>
                      <div>
                        <p className="text-xs text-text-secondary font-bold uppercase tracking-wider mb-1">Success</p>
                        <p className="text-lg font-extrabold text-green">{agent.successRate}%</p>
                      </div>
                      <div>
                        <p className="text-xs text-text-secondary font-bold uppercase tracking-wider mb-1">Active</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-light-bg rounded-lg p-3">
                        <p className="text-xs text-text-secondary font-bold mb-1">Total Chats</p>
                        <p className="text-xl font-extrabold text-dark">{selectedAgent.totalConversations}</p>
                      </div>
                      <div className="bg-light-bg rounded-lg p-3">
