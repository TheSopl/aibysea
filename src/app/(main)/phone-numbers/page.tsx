    ...
    <>
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div
            className="bg-gradient-to-br from-teal-400/10 to-cyan-400/10 rounded-2xl p-6 border-2 border-teal-200/50 hover:shadow-xl transition-all duration-500 hover:scale-105"
            style={{
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-extrabold text-dark">Your Phone Numbers</h2>
            <p className="text-sm text-text-secondary mt-1">Manage and configure your phone number inventory</p>
          </div>
          <button className="px-4 py-2 bg-gradient-to-r from-teal-400 to-cyan-500 text-white rounded-xl font-bold hover:shadow-lg transition-all duration-300 flex items-center gap-2 hover:-translate-y-0.5">
            <Plus size={18} />
            Add Phone Number
          </button>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span
                    className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold border ${getStatusBadgeColor(
                      phone.status,
                      isPaused
                    )}`}
                  >
                ...
                <div className="flex items-center gap-2">
                  {displayStatus === 'active' && !isPaused ? (
                    <button
                      ...
                      className="p-2 hover:bg-amber-50 rounded-lg transition-colors group flex-1"
                      title="Pause"
                    >
                      <div className="flex items-center justify-center gap-2 text-amber-600 group-hover:scale-105 transition-transform">
                        <Pause size={18} />
                    ...
                    <button
                      onClick={() => togglePause(phone.id)}
                      className="p-2 hover:bg-green-50 rounded-lg transition-colors group flex-1"
                      title="Resume"
                    >
                      <div className="flex items-center justify-center gap-2 text-green-600 group-hover:scale-105 transition-transform">
                        <Play size={18} />
                        <span className="text-sm font-bold">Resume</span>
                      </div>
                    </button>
                  )}
                  <button className="p-2 hover:bg-light-bg rounded-lg transition-colors group" title="Edit">
                  ...
                  <button className="p-2 hover:bg-light-bg rounded-lg transition-colors group" title="Settings">
