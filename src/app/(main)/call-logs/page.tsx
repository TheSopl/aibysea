  ...
  return (
    <>
      ...
      <div className="flex h-[calc(100vh-4rem)]">
        ...
        <div className="flex-1 bg-white border-r border-gray-200 flex flex-col overflow-hidden">
          ...
          <div className="p-4 border-b border-gray-200 space-y-3 bg-white">
            ...
            <div className="flex items-center gap-3">
              <label className="text-xs font-bold text-gray-600 whitespace-nowrap">Agent:</label>
              <select
                value={agentFilter}
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <label className="text-xs font-bold text-gray-600">Direction:</label>
            ...
            <div className="flex items-center gap-2">
              <label className="text-xs font-bold text-gray-600 whitespace-nowrap">Date Range:</label>
              <input
                type="date"
                value={dateFrom}
            ...
            {filteredCalls.map((call, index) => (
              <div
                ...
                className={`p-4 border-b border-gray-100 cursor-pointer transition-all duration-300 hover:bg-gray-50 ${
                  selectedCall?.id === call.id ? 'bg-teal-50 border-l-4 border-l-teal-500 shadow-md' : ''
                }`}
                style={{
        ...
        {selectedCall ? (
          <div className="w-96 bg-white border-l border-gray-200 flex flex-col sticky right-0 top-0 overflow-hidden shadow-lg">
            {/* Detail Header */}
            <div className="p-4 border-b border-gray-200 bg-gradient-to-r from-white to-teal-50">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  <label className="text-gray-600 font-bold uppercase tracking-wider">Agent</label>
                  <p className="text-dark font-semibold mt-1">{selectedCall.agent}</p>
                </div>
                <div>
                  <label className="text-gray-600 font-bold uppercase tracking-wider">Duration</label>
                  <p className="text-dark font-semibold mt-1">{selectedCall.duration.toFixed(1)} min</p>
                </div>
                <div>
                  <label className="text-gray-600 font-bold uppercase tracking-wider">Time</label>
                  <p className="text-dark font-semibold mt-1">{selectedCall.time}</p>
                </div>
                <div>
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="space-y-3 relative pl-6">
                  ...
                  {selectedCall.events.map((event, idx) => (
                    <div key={idx} className="relative">
                      <div className="absolute -left-3.5 top-0.5 w-3 h-3 bg-teal-500 rounded-full border-2 border-white shadow-md"></div>
                      <div>
                        <p className="text-sm font-bold text-dark">{event.action}</p>
              ...
              <div className="p-4 border-b border-gray-200">
                ...
                <div>
                  <label className="text-xs font-bold text-gray-600 uppercase tracking-wider">Keywords</label>
              ...
              <div className="p-4 border-b border-gray-200">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm"
                />
              </div>
            </div>
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 space-y-2">
              ...
              <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-gray-200 text-dark rounded-lg font-bold text-sm hover:bg-gray-50 transition-all">
