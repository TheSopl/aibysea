...
const ConfidenceScoresComponent = ({ data }: { data: ConfidencePoint[] }) => (
  <div className="bg-white border border-gray-200 rounded-design-lg p-6 md:p-8 shadow-card hover:shadow-card-hover transition-all duration-300">
    <h3 className="text-lg font-bold text-dark mb-4 md:mb-6">Decision Confidence</h3>
