              ...
              <div className="space-y-2">
                {results.map(result => (
                  <button
                    key={result.id}
                    onClick={() => setOpen(false)}
                    className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-light-bg dark:hover:bg-slate-700 transition-all duration-200 group cursor-pointer text-left"
                  >
